...
var allGems = util_collection.CombineMaps(standardGems, engineerGems, metaGems, shaGems)
...
func GemData_ByStat(stats *StatBlock) GemInfo {
...
func GemData_IsMeta(gem *GemInfo) bool {
	_, exists := metaGems[gem.Id]
	return exists
}
