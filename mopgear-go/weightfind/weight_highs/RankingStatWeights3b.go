...
func (ranker *RankingStatWeightProcess3b) SetTargetRatios(targetRatios weight_types.SimPriorityBasic) {
...
func (ranker *RankingStatWeightProcess3b) RunMultiRound() (*util_async.FutureCancellable[weight_types.WeightResult1], error) {
...
func (ranker *RankingStatWeightProcess3b) RunSinglePassFromExternal(initial weight_types.Weight1Basic) (*util_async.FutureCancellable[weight_types.WeightResult1], error) {
	// FULL RUN
	ranker.dataSample = ranker.dataAllOriginal
	ranker.newBuilder()
	ranker.prepareRankings()
...
func (ranker *RankingStatWeightProcess3b) setupInitialFromInternalWeights(internalWeights weight_types.Weight1Basic) {
...
*/
func (ranker *RankingStatWeightProcess3b) extractAndReportSolution(solution *highs.Solution) weight_types.Weight1Basic {
