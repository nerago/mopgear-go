...
func (grid *GridStatWeightProcess) Run() (*util_async.FutureCancellable[weight_types.WeightResult1], error) {
	...
	return util_async.FutureCancellable_MapValue(solutionFuture, func(linearResult util_highs.LinearResult) weight_types.WeightResult1 {
		if solution, err2 := linearResult.GetSolutionAndSaveLog(grid.printer); err2 == nil {
