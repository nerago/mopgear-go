...
func accuracyPrepareCalcRangeRegular(inputData []*weight_types.AccuracyInfoPrePrepare) []*weight_types.AccuracyInfoPrepared {
	return accuracyPrepareGeneral(inputData, func(a, b *weight_types.AccuracyInfoPrePrepare) bool {
		return util.FloatsApproxEquals(a.SimScore, b.SimScore)
	})
}

func accuracyPrepareCalcRangeComplicated(inputData []*weight_types.AccuracyInfoPrePrepareExtended) []*weight_types.AccuracyInfoPrepared {
