...
// statA*weight1A + statB*weight1B + statC*weight1C - simValue/scales = -offset
func (calc2 *gearWeight2Calc) calc(statTotalColumns *stats.StatTypeMap[*columnInfo], weight2 *weight_types.Weight2Extended) (simValueTotalColumns map[stats.SimType]*columnInfo) {
...
func (calc2 *gearWeight2Calc) calcSim(simType stats.SimType, nestedWeights iter.Seq2[stats.StatType, float64], simEntry weight_types.SimPriorityEntry, statTotalColumns *stats.StatTypeMap[*columnInfo]) (simValueColumn *columnInfo) {
