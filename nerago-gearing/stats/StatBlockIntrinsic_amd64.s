...
TEXT ·StatBlock_StatBlockFloat_MultiplyForTotalSum3(SB), NOSPLIT|NOFRAME, $0-24
    MOVQ          a+0(FP), AX
    MOVQ          b+8(FP), BX
...
TEXT ·StatBlock_StatBlockFloat_MultiplyForTotalSum3_old(SB), NOSPLIT|NOFRAME, $0-24
    MOVQ          a+0(FP), AX
    MOVQ          b+8(FP), BX
