...
func WeightTweakerWithLogging(startWeight weight_types.Weight1Basic, weightStats []stats.StatType, targetRatio stats.SimData, inputData []weight_types.WeightInput, printer *util.PrintRecorder) (weight_types.Weight1Basic, float64) {
...
func weightTweakerInternalLogged(startWeight weight_types.Weight1Basic, tweakStart float64, weightStats []stats.StatType, targetRatio stats.SimData, inputData []weight_types.WeightInput, printer *util.PrintRecorder) (weight_types.Weight1Basic, float64) {
...
// TODO compare logic
func weightTweakerInternal_Fast(startWeight weight_types.Weight1Basic, tweakStart float64, weightStats []stats.StatType, simTypes []stats.SimType, targetRatio stats.SimData, inputData []weight_types.WeightInput) (weight_types.Weight1Basic, float64) {
	increment := tweakStart
	factor := 1 + increment
...
func WeightTweaker_FastCached(startWeight weight_types.Weight1Basic, weightStats []stats.StatType, evaluate *EvaluateAccuracyPrepared) (weight_types.Weight1Basic, float64) {
