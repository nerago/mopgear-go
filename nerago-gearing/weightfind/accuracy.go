...
func EvaluateAccuracyRanged(statWeights weight_types.WeightResult, requiredSims []stats.SimType, simRatios stats.SimData, inputData []weight_types.WeightInput) float64 {
...
func EvaluateAccuracyStatisticalDeviations(statWeights weight_types.WeightResult, requiredSims []stats.SimType, simRatios stats.SimData, inputData []weight_types.WeightInput) float64 {
	if statWeights.IsEmpty() {
		return 0
	}
