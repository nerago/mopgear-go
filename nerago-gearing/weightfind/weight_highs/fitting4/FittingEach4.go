...
func (fe *FittingEachStatWeightProcess4) Run(cancel util_async.CancelSignal) weight_types.WeightResult {
...
func (fe *FittingEachStatWeightProcess4) launchEachNested() {
