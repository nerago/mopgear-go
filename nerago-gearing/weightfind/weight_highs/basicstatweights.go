...
type BasicStatWeightProcess struct {
	...
	unitStatValues  util_collection.MapMap[stats.StatType, stats.SimType, float64]
...
func (basic *BasicStatWeightProcess) Run() *util_async.FutureCancellable[weight_types.WeightResult] {
