...
func trinketSims(printer *util.PrintRecorder) {
	...
	for _, itemId := range itemIds {
		...
		switch itemId {
		case 94519:
			item = tools.Reforger_SinglePreset(item, &stats.ReforgeRecipe{From: stats.Stat_Crit, To: stats.Stat_Mastery})
		case 94527:
			item = tools.Reforger_SinglePreset(item, &stats.ReforgeRecipe{From: stats.Stat_Expertise, To: stats.Stat_Haste})
		}
