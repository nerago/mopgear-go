...
func simEachInitialResult(input *FindUpgrades_SimInputs, inputList []upgradeItemResult, goal stats.OptimiseGoal, model *model.Model, baseSim *simulate.SimResultStats, tracker *util.TrackProgress, printer *util.PrintRecorder) []upgradeItemResultWithSim {
